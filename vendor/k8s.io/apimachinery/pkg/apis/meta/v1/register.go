...
// caller:
// 	1. kubernetes/scheme/register.go -> init()
//
...
func AddToGroupVersion(scheme *runtime.Scheme, groupVersion schema.GroupVersion) {
	...
	// register manually. This usually goes through the SchemeBuilder, 
