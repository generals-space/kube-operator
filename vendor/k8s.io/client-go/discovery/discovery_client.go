...
// This client can be used to discover supported resources in the API server.
// caller:
// 	1. NewDiscoveryClientForConfigOrDie()
// 	2. kubernetes/clientset.go -> NewForConfig()
// 	3. discovery/cached/disk/cached_discovery.go -> NewCachedDiscoveryClientForConfig()
...
// caller: kubernetes/clientset.go -> NewForConfigOrDie()
