...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"generals-space/kube-operator/pkg/apis/kubegroup/v1.PodCluster":       schema_pkg_apis_kubegroup_v1_PodCluster(ref),
		"generals-space/kube-operator/pkg/apis/kubegroup/v1.PodClusterList":   schema_pkg_apis_kubegroup_v1_PodClusterList(ref),
		"generals-space/kube-operator/pkg/apis/kubegroup/v1.PodClusterSpec":   schema_pkg_apis_kubegroup_v1_PodClusterSpec(ref),
		"generals-space/kube-operator/pkg/apis/kubegroup/v1.PodClusterStatus": schema_pkg_apis_kubegroup_v1_PodClusterStatus(ref),
...
func schema_pkg_apis_kubegroup_v1_PodCluster(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PodCluster",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("generals-space/kube-operator/pkg/apis/kubegroup/v1.PodClusterSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("generals-space/kube-operator/pkg/apis/kubegroup/v1.PodClusterStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"generals-space/kube-operator/pkg/apis/kubegroup/v1.PodClusterSpec", "generals-space/kube-operator/pkg/apis/kubegroup/v1.PodClusterStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_kubegroup_v1_PodClusterList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("generals-space/kube-operator/pkg/apis/kubegroup/v1.PodCluster"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"generals-space/kube-operator/pkg/apis/kubegroup/v1.PodCluster", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_kubegroup_v1_PodClusterSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PodClusterSpec defines the desired state of PodCluster",
				Type:        []string{"object"},
			},
		},
	}
...
func schema_pkg_apis_kubegroup_v1_PodClusterStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PodClusterStatus defines the observed state of PodCluster",
				Type:        []string{"object"},
			},
		},
	}
